        ...
        <div className="mx-auto flex flex-col p-2 md:grid">
          <div className="flex md:contents">
            <div className="relative col-start-1 col-end-2 mx-auto">
              ...
              <div className="absolute top-1/2 -mt-3 h-6 w-6 rounded-full border-4 backdrop-blur-lg"></div>
            </div>
            <div
              data-aos="fade-down"
              data-aos-duration="1000"
              className="relative col-start-2 col-end-6 my-6 ml-4 rounded-xl p-4 backdrop-blur-lg lg:w-[450px]"
            >
